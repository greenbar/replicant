...
public class PaintingTaskTest extends TestCase {
  ...
  public void setUp() throws Exception {
    expecter = orderedExpecter();
    requestQueue      = new MockRequestQueue(expecter);
    painter           = new MockWidgetPainter(expecter);
    widgetRepository  = new MockWidgetRepository(expecter);
