...
public class MethodMocker2Test extends TestCase {
  ...
  private MethodMocker2<X, A, B> methodMocker;

  public void setUp() throws Exception {
    baseMethodMocker = new MockBaseMethodMocker<X>(MOCK, METHOD);
    methodMocker    = new MethodMocker2<X, A, B>(MOCK, METHOD, baseMethodMocker);
  }
