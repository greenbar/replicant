...
public class MethodMocker4Test extends TestCase {
  ...
  private static final List<Object> ARGUMENTS     = list((Object)ARG1, ARG2, ARG3, ARG4);
  ...
  private MethodMocker4<X, A, B, C, D> methodMocker;

  public void setUp() throws Exception {
    baseMethodMocker = new MockBaseMethodMocker<X>(MOCK, METHOD);
    methodMocker    = new MethodMocker4<X, A, B, C, D>(MOCK, METHOD, baseMethodMocker);
  }
  
  public void testExpect() throws Exception {
    baseMethodMocker.onCallToExpectReturn(RESPONSE);
    
    Response<X> response = methodMocker.expect(ARG1, ARG2, ARG3, ARG4);
  ...
  public void testCall() throws Exception {
    ...
    X returnValue = methodMocker.call(ARG1, ARG2, ARG3, ARG4);
  ...
  public void testAssertCalled() throws Exception {
    ...
    try {
      methodMocker.assertCalled(ARG1, ARG2, ARG3, ARG4);
