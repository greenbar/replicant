...
public class MethodMocker5Test extends TestCase {
  ...
  private static final D            ARG4          = new D(4);
  private static final E            ARG5          = new E(5);
  private static final List<Object> ARGUMENTS     = list((Object)ARG1, ARG2, ARG3, ARG4, ARG5);
  ...
  private MethodMocker5<X, A, B, C, D, E> methodMocker;

  public void setUp() throws Exception {
    baseMethodMocker = new MockBaseMethodMocker<X>(MOCK, METHOD);
    methodMocker    = new MethodMocker5<X, A, B, C, D, E>(MOCK, METHOD, baseMethodMocker);
  }
  
  public void testExpect() throws Exception {
    baseMethodMocker.onCallToExpectReturn(RESPONSE);
    
    Response<X> response = methodMocker.expect(ARG1, ARG2, ARG3, ARG4, ARG5);
  ...
  public void testCall() throws Exception {
    ...
    X returnValue = methodMocker.call(ARG1, ARG2, ARG3, ARG4, ARG5);
  ...
  public void testAssertCalled() throws Exception {
    ...
    try {
      methodMocker.assertCalled(ARG1, ARG2, ARG3, ARG4, ARG5);
