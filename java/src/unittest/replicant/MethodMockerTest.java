...
public class MethodMockerTest extends TestCase {
  ...
  private MethodMocker<X>         methodMocker;

  public void setUp() throws Exception {
    baseMethodMocker = new MockBaseMethodMocker<X>(MOCK, METHOD);
    methodMocker     = new MethodMocker<X>(MOCK, METHOD, baseMethodMocker);
  }
  
  public void testExpect() throws Exception {
    baseMethodMocker.onCallToExpectReturn(RESPONSE);
    
    Response<X> response = methodMocker.expect(ARG1, ARG2);
  ...
  public void testCall() throws Exception {
    ...
    X returnValue = methodMocker.call(ARG1, ARG2);
  ...
  public void testAssertCalled() throws Exception {
    ...
    try {
      methodMocker.assertCalled(ARG1, ARG2);
